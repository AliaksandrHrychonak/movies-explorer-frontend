...
const SearchInput = ({ stateCheckBox, toogleCheckBox, onSearch, setMoviesFilter, lastSearchLocal }) => {
  ...
  return (
    <section className="search">
      <form className="form-search" noValidate onSubmit={handleSubmit}>
        ...
        <input type="text" name="film" required className="form-search__input" placeholder="Фильм" value={values.film || isLastSearch || ''} onChange={handleChange} autoComplete="off" />
